...
model = keras.models.load_model("Models/model_state_2.hdf5")                                                                                                    		#Load a saved model (Comment if the model does not exist during the first trial).
...
model.save("Models/model_state_2.hdf5")                                         							#Saving the trained model.
